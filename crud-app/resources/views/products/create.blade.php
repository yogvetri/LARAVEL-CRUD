                ...
                <form action="/products/store" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <textarea name="description" id="description" class="form-control @if($errors->has('description')) {{'is-invalid'}} @endif" style="resize: none; height: 150px;" placeholder="Enter Product Description" value="{{ old('description') }}"></textarea>
